...
////////////////
import WoodbineFitnessOrigenProductScreen from './screen/WoodbineFitnessOrigenProductScreen';
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="WoodbineFitnessOrigenProductScreen"
            component={WoodbineFitnessOrigenProductScreen}
      ...
      <NavigationContainer>
        {!louderIsEnded || !aceptTransperency || !completeLink ? (
          <View
            ...
            <Animated.Image
              source={require('./assets/new/Loader1.png')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./assets/new/Loader2.png')}
              style={{
                //...props.style,
